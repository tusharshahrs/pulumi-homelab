...
// https://kubernetes-sigs.github.io/aws-load-balancer-controller/guide/controller/subnet_discovery/
const public_subnet_k8s_tag = {"kubernetes.io/role/elb":"1"}
const private_subnet_k8s_tag = {"kubernetes.io/role/internal-elb":"1"}
...
const vpc = new awsx.ec2.Vpc(vpc_name, {
  ...
  subnets: [
    { type: "public", tags: public_subnet_k8s_tag},
    { type: "private", tags: private_subnet_k8s_tag },
],
  tags: baseTags,
});
