...
/* const go_demo_2_dbDeployment = new k8s.apps.v1.Deployment("go_demo_2_dbDeployment", {
    apiVersion: "apps/v1",
    kind: "Deployment",
    metadata: {
        name: "go-demo-2-db",
...
const go_demo_2_dbService = new k8s.core.v1.Service("go_demo_2_dbService", {
    apiVersion: "v1",
    kind: "Service",
    metadata: {
        name: "go-demo-2-db",
...
const go_demo_2_apiDeployment = new k8s.apps.v1.Deployment("go_demo_2_apiDeployment", {
    apiVersion: "apps/v1",
    kind: "Deployment",
    metadata: {
        name: "go-demo-2-api",
