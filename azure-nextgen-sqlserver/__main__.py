...
export("DATABASE NAME",server_resource.name)
export("SQLSERVER STATE",server_resource.state)
export("SQLSERVER FQDN",server_resource.fully_qualified_domain_name)
export("SQLSERVER KIND",server_resource.kind)
export("SQLSERVER TYPE",server_resource.type)
export("SQLSERVER Display name of the Azure Active Director",server_resource.external_administrator_login)
export("SQLSERVER ID of the Active Azure Directory object with admin permissions on this server",server_resource.external_administrator_sid)