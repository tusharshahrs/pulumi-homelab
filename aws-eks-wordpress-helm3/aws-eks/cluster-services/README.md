...
1. Configure the stack.
    ...
    $ pulumi config set k8s-aws-index-svcs:identityStackRef myUser/k8s-aws-identity/dev-1573589109
    $ pulumi config set k8s-aws-index-svcs:clusterStackRef myUser/k8s-aws-index/dev-1571780002
    ```
